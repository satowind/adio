      ...
      <section style="background-image:url('img/bg-1.jpg');" class="breadcrumbs">
        <div class="container">
          <div class="text-center breadcrumbs-item">
            <h1>Vission</h1><a href="{{url('/')}}">home</a><i class="fa fa-angle-right"></i><a href="#">Our Vission</a>
          </div>
        </div>
      </section>
      <!-- ! breadcrumbs end-->
      ...
      <div class="container">
        <div class="row">
          ...
          <section class="page-section portfolio-item mb-0 pt-0 pb-50">
              <div class="pic no-hover"><img src="img/vission.jpg" alt="">
                <div class="hover-effect"></div>
                <div class="links"><a href="img/vission.jpg" class="link-icon flaticon-interface fancy"></a><a href="#" class="link-icon flaticon-tool"></a></div>
              </div>
              <div class="row">
                <div class="col-sm-10 col-sm-offset-1 fs-14">
                  <h2 class="mt-30">Our Vision</h2>
                  <p>To be the reference point for financial inclusion in Africa.</p>
