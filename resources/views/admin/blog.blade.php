...
@section('content')
        ...
        <div>
             <td colspan="4"><div class="text-center"><a href="{{url('admin/addblog')}}" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Add Post</a></div></td>
        </div>
